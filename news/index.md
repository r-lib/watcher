...
- Fixes installation failing on systems with a partial or broken system
  ...
  ([\#48](https://github.com/r-lib/watcher/issues/48)).
- Updates bundled ‘libfswatch’ source to 1.22.0 release. On Linux, this
  fixes ‘Renamed’ events reporting only the watched directory path when
  a file is moved in from an unwatched location.
...
- [`watcher()`](https://watcher.r-lib.org/reference/watcher.md) now
